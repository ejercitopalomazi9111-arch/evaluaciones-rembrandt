...
export function BarraAccionMovil() {
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 border-t border-white/15 bg-tinta lg:hidden no-imprimir"
      style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}
    >
      <a
        href={`tel:${CONTACTO.telefonoE164}`}
        className="flex min-h-14 items-center justify-center gap-2 border-r border-white/15 font-mono text-[0.68rem] font-bold tracking-[0.12em] text-white uppercase"
      >
