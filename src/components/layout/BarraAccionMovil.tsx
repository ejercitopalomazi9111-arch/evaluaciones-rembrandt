...
export function BarraAccionMovil() {
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 border-t border-tinta bg-hueso lg:hidden no-imprimir"
      style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}
    >
      <a
        href={`tel:${CONTACTO.telefonoE164}`}
        className="flex min-h-14 items-center justify-center gap-2 border-r border-tinta/15 font-mono text-[0.68rem] font-bold tracking-[0.12em] text-tinta uppercase"
      >
